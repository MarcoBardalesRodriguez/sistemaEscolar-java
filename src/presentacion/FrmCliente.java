...
public class FrmCliente extends javax.swing.JInternalFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if (txtNombre.getText().length() == 0 || txtNombre.getText().length() > 20) {
            JOptionPane.showMessageDialog(this, "Debes de ingresar un nombre y no debe ser mayor a 20 caracteres, este campo es obligatorio", "Sistema", JOptionPane.WARNING_MESSAGE);
